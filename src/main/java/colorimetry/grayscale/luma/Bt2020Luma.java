...
public final class Bt2020Luma implements Grayscale {
    ...
    public double[] toGrayXyz(double[] xyz) {
        double[] rgb = ColorConverter.convert(Xyz.INSTANCE, SRgb.of(Bt2020RgbLinear.INSTANCE), xyz);
        double y = WR * rgb[0] + WG * rgb[1] + WB * rgb[2];
        
        return ColorConverter.convert(SRgb.of(Bt2020RgbLinear.INSTANCE), Xyz.INSTANCE, new double[]{y, y, y});
    }
}