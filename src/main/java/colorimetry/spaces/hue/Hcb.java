...
public final class Hcb implements ColorSpace {
    public static final Hcb INSTANCE = new Hcb(Bt709RgbLinear.INSTANCE);
     ...
     *
     * @param parent the linear RGB space this HCB derives from
     * @return a new HCB descriptor parented to the given RGB
     */
    public static Hcb of(RgbLike parent) {
        return new Hcb(parent);
    }
    ...
    private static double[] hcbToRgb(double hue, double chroma, double brightness) {
        ...
        double s = ColorSpace.clamp(c / v, 0.0, 1.0);
