...
public final class Hsl implements ColorSpace {
    public static final Hsl INSTANCE = new Hsl(Bt709RgbLinear.INSTANCE);
     ...
     *
     * @param parent the linear RGB space this HSL derives from
     * @return a new HSL descriptor parented to the given RGB
     */
    public static Hsl of(RgbLike parent) {
        return new Hsl(parent);
    }
