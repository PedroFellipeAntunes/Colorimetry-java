...
public final class Hsp implements ColorSpace {
    public static final Hsp INSTANCE = new Hsp(Bt709RgbLinear.INSTANCE);
     ...
     *
     * @param parent the linear RGB space this HSP derives from
     * @return a new HSP descriptor parented to the given RGB
     */
    public static Hsp of(RgbLike parent) {
        return new Hsp(parent);
    }
     ...
     */
    private double solveMaxChannel(double perceived, double saturation, double hueFraction, double weightMax, double weightMid, double weightMin) {
     ...
     */
    private double[] hspToRgb(double hue, double saturation, double perceived) {
     ...
     */
    private double[] rgbToHsp(double red, double green, double blue) {
        ...
        double perceived = Math.sqrt(wr * red * red + wg * green * green + wb * blue * blue);
