...
public final class Hwb implements ColorSpace {
    public static final Hwb INSTANCE = new Hwb(Bt709RgbLinear.INSTANCE);
     ...
     *
     * @param parent the linear RGB space this HWB derives from
     * @return a new HWB descriptor parented to the given RGB
     */
    public static Hwb of(RgbLike parent) {
        return new Hwb(parent);
    }
